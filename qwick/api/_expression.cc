...
void export_expression(py::module &m) {
    ...
    py::class_<AExpression, std::shared_ptr<AExpression>>(m, "AExpression")
        ...
        .def("__str__", &AExpression::_print_str)
        .def("__eq__", [](const AExpression &a, const AExpression &b) { return a == b; })
        .def("__ne__", [](const AExpression &a, const AExpression &b) { return a != b; })
        .def("__add__", [](const AExpression &a, const AExpression &b) { return a + b; })
        .def("__sub__", [](AExpression &a, AExpression &b) { return a - b; })
        .def("__mul__", [](AExpression &a, AExpression &b) { return a * b; })
        .def("__mul__", [](AExpression &a, double &b) { return a * b; })
        .def("__rmul__", [](AExpression &a, double &b) { return a * b; })
        .def("__mul__", [](AExpression &a, int &b) { return a * b; })
        .def("__rmul__", [](AExpression &a, int &b) { return a * b; })
